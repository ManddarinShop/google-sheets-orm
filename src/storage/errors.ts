...
export const STORAGE_ERROR_CODES = {
  ...
  INVALID_CUTOVER_OPTIONS: "invalid_cutover_options",
  CUTOVER_STATE_INVALID: "cutover_state_invalid",
  CUTOVER_IDENTITY_CONFLICT: "cutover_identity_conflict",
  CUTOVER_CHECKPOINT_FAILED: "cutover_checkpoint_failed",
  INVALID_SYNC_DEPLOYMENT_CONFIG: "invalid_sync_deployment_config",
  INVALID_SYNC_OPERATIONAL_LIMITS: "invalid_sync_operational_limits",
  SYNC_OPERATIONAL_HEALTH_UNAVAILABLE: "sync_operational_health_unavailable",
