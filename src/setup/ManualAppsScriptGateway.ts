...
export function createManualAppsScriptGatewayIntro(
  ...
  return [
    ...
    "8. Run setupTypedSheets(), or reload the Sheet and click typed-sheets > Setup gateway.",
    "9. Paste that /exec URL into the Apps Script prompt.",
...
export function createManualAppsScriptGatewayCodeMessage(
  ...
  return [
    ...
    "After deployment, run setupTypedSheets() and paste the Web App /exec URL when prompted.",
    "",
    "Copy command:",
    createClipboardCopyCommand(manualAppsScriptGatewayCodePath, platform),
  ].join("\n");
